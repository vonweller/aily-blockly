...
// 
export function processingCodejs(libJson, libName) {
    try {
...
// 替换json generator中的变量，如：${PIN1}
function processJsonVar(code: string, vars: object): string {
