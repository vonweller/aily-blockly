...
- For web fetching: if a fetch/web fetch call returns mostly page chrome, placeholders, or missing main body content from a JS-rendered site, retry with the webview bridge path and pass \`waitMs\` so the page has time to hydrate before extraction. Start with about 1000-3000ms and increase once if needed.
